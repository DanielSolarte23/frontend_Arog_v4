    ...
    const renderProgreso = () => {
        return (
            <div className="flex justify-between mb-6">
                <div className={`w-1/3 text-center ${paso >= 1 ? 'text-verde font-bold' : ''}`}>
                    <div className={`rounded-full h-8 w-8 flex items-center justify-center mx-auto mb-1 ${paso >= 1 ? 'bg-verde text-white' : 'bg-gray-200'}`}>1</div>
                    <span className="text-sm">Datos del Cliente</span>
                </div>
                <div className={`w-1/3 text-center ${paso >= 2 && tienePlan ? 'text-verde font-bold' : ''}`}>
                    <div className={`rounded-full h-8 w-8 flex items-center justify-center mx-auto mb-1 ${paso >= 2 && tienePlan ? 'bg-verde text-white' : 'bg-gray-200'}`}>2</div>
                    <span className="text-sm">Plan de Pago</span>
                </div>
                <div className={`w-1/3 text-center ${paso >= 3 ? 'text-verde font-bold' : ''}`}>
                    <div className={`rounded-full h-8 w-8 flex items-center justify-center mx-auto mb-1 ${paso >= 3 ? 'bg-verde text-white' : 'bg-gray-200'}`}>3</div>
                ...
                {paso === 3 && (
                    <div className="animate-fadeIn">
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg mb-4">
                            ...
                            <p><strong>Fecha Pago Fijo:</strong> {cliente.fechaPagoFijo}</p>
