    ...
    if (item.tipoArchivo.startsWith("image/")) {
      return (
        <img
          ...
          loading="lazy"
          width={item.ancho > 500 ? 500 : item.ancho}
        />
      );
    ...
    <>
      <header className="border bg-white border-gray-200 rounded-lg h-full">
        <div className="h-full">
          ...
          <div className="h-8/10 w-full flex justify-center items-center p-10 ">
            <div className="grid grid-rows-2 grid-cols-2 sm:grid-cols-3 gap-2 md:gap-4 p-4 border rounded-md h-full w-full">
              {/* {[...Array(6)].map((_, i) => (
                <div
                  key={i}
                  onClick={() => setModalCard(true)}
              ...
              {media.map((item) => (
                ...
                >
                  {/* <img
                    src={renderMediaItem(item)}
                    alt=""
                    className="rounded-lg object-contain"
                  /> */}
                  <div className="media-content rounded-lg object-contain">
