        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div className="text-sm">
              <span className="font-medium text-gray-700">Creador:</span> {encuesta.creador.nombres} {encuesta.creador.apellidos}
            </div>
            {encuesta.fechaExpiracion && (
              <div className="text-sm">
                ...
                {isExpired && <span className="ml-2 text-red-600 font-medium">(Expirada)</span>}
              </div>
            )}
            <div className="text-sm">
              ...
              <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                ...
                encuesta.estado === 'CERRADA' ? 'bg-red-100 text-red-800' :
