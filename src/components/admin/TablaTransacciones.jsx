...
//   const idPago = params.id;
  ...
  const currentItems = filteredTransacciones.slice(
    indexOfFirstItem,
    indexOfLastItem
  );
  ...
  return (
    <div className="relative overflow-x-auto bg-white h-full border-gray-200 rounded-lg fixed">
        ...
        {transacciones.length === 0 ? (
          <div className="text-center">
            <p className="text-gray-500">
              No existen transacciones relacionadas a este pago.
            </p>
          </div>
        ) : (
